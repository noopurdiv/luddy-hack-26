...
class Model:
    ...
    def __init__(self,
        ...
        if model_dir is None:
            self.model_dir = str((Path(__file__).resolve().parent / "line-model").resolve())
        else:
    ...
    def save(self) -> None:
        """Save model to file."""
        self.snap_ID += 1
        self.saver.save(self.sess, os.path.join(self.model_dir, 'snapshot'), global_step=self.snap_ID)
